            ...
            <div class="col-12">
             ...
             <!-- input texto -->
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre" placeholder="Ingrese el nombre aqui">
                  <small id="helpId" class="form-text text-muted">Ingrese el nombre del usuario</small>
                </div>
                <!-- input password -->
                <div class="form-group">
                  <label for="password">Contraseña</label>
                  <input type="password" class="form-control" name="password" placeholder="Ingrese el pass">
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="descripcion" id="" rows="3" maxlength="100" placeholder="Escriba no mas de 100 caracteres"></textarea>
                </div>
